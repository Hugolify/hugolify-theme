...
window.template.cookieConsent = {
  init: function () {
    ...
    this.cookieConsentOkButton = document.querySelector(
      '.js-gdpr-cookie-consent-btn-ok'
    );
    this.cookieConsentKoButton = document.querySelector(
      '.js-gdpr-cookie-consent-btn-ko'
    );
    this.displayAgain = document.querySelector(
      '.js-gdpr-cookie-consent-display-again'
    );
  ...
  setCookieAcceptance: function (accepted) {
    'use strict';
    Cookies.set('gdpr.cookie_consent.ok', accepted, {
      path: '/',
      expires: 365
    });
