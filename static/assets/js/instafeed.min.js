...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(t)
    : ((e =
        'undefined' != typeof globalThis ? globalThis : e || self).Instafeed =
        t());
})(this, function () {
  'use strict';
  function e(e, t) {
  ...
  function t(t) {
    ...
    e(
      ...
      e(
        !o.apiLimit || 'number' == typeof o.apiLimit,
  ...
  return (
            ...
            this._state.node
              ? (this._debug('run', 'got dom node', this._state.node),
                ...
                this._getAccessToken(function (t, o) {
                  if (t)
                    return (
                      e._debug('onTokenReceived', 'error', t),
                      void e._fail(
                        new Error('error getting access token: ' + t.message)
                      )
                    );
                  e._debug('onTokenReceived', 'got token', o),
                    ...
                    e._showNext(function (t) {
                      if (t)
                        return (
                          e._debug('onNextShown', 'error', t), void e._fail(t)
                        );
                      e._finish();
                    });
                }),
        ...
        ? e._state.running
          ...
          : (e._start(),
            void e._showNext(function (t) {
              if (t)
                return e._debug('onNextShown', 'error', t), void e._fail(t);
              e._finish();
            }))
    ...
    (t.prototype._showNext = function (e) {
      ...
      if (
        (t._debug('showNext', 'pool', t._state.pool.length, t._state.pool),
        t._state.pool.length > 0)
      ) {
        if (
          ((n = i
            ? t._state.pool.splice(0, t._options.limit)
            : t._state.pool.splice(0)),
          t._debug('showNext', 'items from pool', n.length, n),
          t._debug(
            'showNext',
            'updated pool',
            t._state.pool.length,
            t._state.pool
          ),
          t._options.mock)
        )
        ...
        t._state.paging && 'string' == typeof t._state.paging.next
          ? (o = t._state.paging.next)
          : ((o =
              ...
              t._state.token),
            t._options.apiLimit || 'number' != typeof t._options.limit
              ? 'number' == typeof t._options.apiLimit &&
                (t._debug(
                  'showNext',
          ...
          t._makeApiRequest(o, function (o, n) {
            ...
            if (o)
              return (
                t._debug('onResponseReceived', 'error', o),
    ...
    (t.prototype._processData = function (e) {
      ...
      for (var c = 0; c < e.data.length; c++) {
        if (((a = this._getItemData(e.data[c])), t))
          try {
            ...
            throw (
              (this._debug('processData', 'error calling transform', f),
        ...
        if (o) {
          try {
            ...
            throw (
              (this._debug('processData', 'error calling filter', f),
      ...
      if (n)
        try {
          ...
          throw (
            (this._debug('processData', 'error calling sort', f),
    ...
    (t.prototype._renderData = function (e) {
      ...
      if (
        ...
        for (var a = 0; a < e.length; a++) {
          if (((n = e[a]), o))
            try {
              ...
              throw (
                (this._debug('renderData', 'error calling render', u),
        ...
        for (
          this._debug('renderData', 'html content', r),
      ...
      ((i = new XMLHttpRequest()).ontimeout = function () {
        ...
        (i.onload = function (e) {
          ...
          200 === i.status
            ...
            : s(new Error('status code ' + i.status));
        }),
        i.open('GET', e, !0),
